...
| **Architecture (other)** | ✅ 5 / ⏭️ rest | ARC-003, ARC-007 (safe fix), ARC-011, ARC-019, ARC-025 resolved. ARC-004/005/006/008/009/010/012–028 remain (see Remaining). |
| **Code Quality** | ✅ 4 / ⏭️ rest | QA-001, QA-003, QA-007, QA-010 resolved. QA-002/004/005/006/008/009/011/012/013 remain. |
...
**Totals**: ~52 audit items resolved across all rounds. **All Security closed; both Critical architecture findings (ARC-001, ARC-002) substantially done; the top High dedup (ARC-003/QA-001) substantially done.** Remaining work is the long tail of Medium/Low architecture, code-quality, and documentation items — ARC-004/005/006/008/009/010 and the doc/code-quality tail.
...
1. **Both Critical architecture findings + the top High dedup are substantially done** (ARC-001 `Terminal` decomposition + ARC-002 `PyTerminal` split + ARC-003/QA-001 binding dedup). The highest-leverage REMAINING items are now **ARC-005 (Cell SmallVec, best self-contained perf win)** and **ARC-004/QA-002 (collapse the 3 near-identical WS handlers)**.
